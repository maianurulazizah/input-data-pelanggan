...
<div class="container">
	<div class="screen">
		<div class="screen__content">
			<form class="login" action="<?= BASEURL ?>Register/prosesregister" method="post">
				<div class="login__field">
					<i class="login__icon fa fa-user-circle"></i>
					<input type="text" class="login__input" placeholder="Nama" name="nama">
				</div>
                <form class="login">
				<div class="login__field">
					<i class="login__icon fa fa-user-circle"></i>
